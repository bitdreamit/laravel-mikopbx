{{--
    FIX 1: Removed bare x-data on the inner div — it had no component and
            broke Alpine scope when Livewire toggled $visible.
    FIX 2: x-transition now lives on the outer wrapper, not a bare x-data div.
    FIX 3: The whole component is already a Livewire component; Livewire handles
            re-rendering when $visible changes. We just need correct Alpine usage.
--}}
<div>
    @if($visible)
